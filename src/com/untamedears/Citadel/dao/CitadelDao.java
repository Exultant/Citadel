...
import com.untamedears.Citadel.DelayedReenforcement;
...
public class CitadelDao {
    ...
    public DelayedReenforcement addReinforcement(Block block, Material material) throws SQLException {
        ...
        return new DelayedReenforcement(tmp);
    }
